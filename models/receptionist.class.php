...
class Receptionist extends baseModel
{
    ...
    {
        $sql = $this->dbConnection->prepare("INSERT INTO recepcionista (name, type_document, document, cellphone, email, password) VALUES (?, ?, ?, ?, ?, ?)");
    ...
    public function update($name,$type_document,$document, $cellphone, $email, $password)
    {
        try
        {
            $sql = $this->dbConnection->prepare("UPDATE recepcionista SET name=:name, type_document=:type_document, document=:document, cellphone=:cellphone, email=:email, password=:password WHERE document=:document");
    ...
    {
        $sql = $this->dbConnection->prepare("DELETE FROM recepcionista WHERE document=:document");

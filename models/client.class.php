...
class Client extends baseModel
{
    ...
    {
        $sql = $this->dbConnection->prepare("INSERT INTO cliente (name, type_document, document, cellphone, email, password) VALUES (?, ?, ?, ?, ?, ?)");
    ...
    public function update($name,$type_document,$document, $cellphone, $email, $password)
    {
        try
        {
            $sql = $this->dbConnection->prepare("UPDATE cliente SET name=:name, type_document=:type_document, document=:document, cellphone=:cellphone, email=:email, password=:password WHERE document=:document");
    ...
    {
        $sql = $this->dbConnection->prepare("DELETE FROM cliente WHERE document=:document");
